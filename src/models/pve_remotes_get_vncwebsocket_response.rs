...
pub struct PveRemotesGetVncwebsocketResponse {
...
impl PveRemotesGetVncwebsocketResponse {
    pub fn new(data: Option<serde_json::Value>) -> PveRemotesGetVncwebsocketResponse {
