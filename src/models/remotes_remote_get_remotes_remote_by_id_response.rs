...
pub struct RemotesRemoteGetRemotesRemoteByIdResponse {
...
impl RemotesRemoteGetRemotesRemoteByIdResponse {
    pub fn new(data: Option<serde_json::Value>) -> RemotesRemoteGetRemotesRemoteByIdResponse {
