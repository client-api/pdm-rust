...
pub enum PdmPveRemotesBondModeEnum {
...
impl std::fmt::Display for PdmPveRemotesBondModeEnum {
...
impl Default for PdmPveRemotesBondModeEnum {
    fn default() -> PdmPveRemotesBondModeEnum {
        Self::BalanceRr
    }
}
