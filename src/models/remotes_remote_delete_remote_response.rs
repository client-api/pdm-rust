...
pub struct RemotesRemoteDeleteRemoteResponse {
...
impl RemotesRemoteDeleteRemoteResponse {
    pub fn new(data: Option<serde_json::Value>) -> RemotesRemoteDeleteRemoteResponse {
