...
pub struct PveRemotesGetPveRemotesByRemoteOptionsResponse {
...
impl PveRemotesGetPveRemotesByRemoteOptionsResponse {
    pub fn new(data: Option<serde_json::Value>) -> PveRemotesGetPveRemotesByRemoteOptionsResponse {
