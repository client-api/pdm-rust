...
pub struct PveRemotesCreateRemoteMigrateResponse {
...
impl PveRemotesCreateRemoteMigrateResponse {
    pub fn new(data: String) -> PveRemotesCreateRemoteMigrateResponse {
