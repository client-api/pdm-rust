...
pub struct SdnGetControllersResponseDataInnerPending {
...
impl SdnGetControllersResponseDataInnerPending {
    /// Changes that have not yet been applied to the running configuration.
    pub fn new() -> SdnGetControllersResponseDataInnerPending {
