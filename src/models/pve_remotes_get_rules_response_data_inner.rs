...
pub struct PveRemotesGetRulesResponseDataInner {
    ...
    pub log: Option<models::PdmLogLevelInEnum>,
...
impl PveRemotesGetRulesResponseDataInner {
    pub fn new(action: String, pos: i64, r#type: String) -> PveRemotesGetRulesResponseDataInner {
