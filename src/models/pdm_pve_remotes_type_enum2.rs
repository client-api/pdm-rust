...
pub enum PdmPveRemotesTypeEnum2 {
    #[serde(rename = "bridge")]
    Bridge,
    #[serde(rename = "bond")]
    Bond,
...
impl std::fmt::Display for PdmPveRemotesTypeEnum2 {
...
impl Default for PdmPveRemotesTypeEnum2 {
    fn default() -> PdmPveRemotesTypeEnum2 {
        Self::Bridge
    }
}
