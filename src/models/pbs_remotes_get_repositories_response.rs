...
pub struct PbsRemotesGetRepositoriesResponse {
...
impl PbsRemotesGetRepositoriesResponse {
    pub fn new(data: Option<serde_json::Value>) -> PbsRemotesGetRepositoriesResponse {
