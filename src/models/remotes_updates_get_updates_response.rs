...
pub struct RemotesUpdatesGetUpdatesResponse {
...
impl RemotesUpdatesGetUpdatesResponse {
    pub fn new(data: Option<serde_json::Value>) -> RemotesUpdatesGetUpdatesResponse {
