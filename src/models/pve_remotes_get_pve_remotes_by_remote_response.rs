...
pub struct PveRemotesGetPveRemotesByRemoteResponse {
...
impl PveRemotesGetPveRemotesByRemoteResponse {
    pub fn new(data: Option<serde_json::Value>) -> PveRemotesGetPveRemotesByRemoteResponse {
