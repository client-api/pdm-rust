...
pub struct PveRemotesGetRepositoriesResponse {
...
impl PveRemotesGetRepositoriesResponse {
    pub fn new(data: Option<serde_json::Value>) -> PveRemotesGetRepositoriesResponse {
