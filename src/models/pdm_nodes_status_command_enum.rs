...
pub enum PdmNodesStatusCommandEnum {
    #[serde(rename = "reboot")]
    Reboot,
...
impl std::fmt::Display for PdmNodesStatusCommandEnum {
...
impl Default for PdmNodesStatusCommandEnum {
    fn default() -> PdmNodesStatusCommandEnum {
        Self::Reboot
    }
}
