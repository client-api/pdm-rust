...
pub struct PbsRemotesGetVncwebsocketResponse {
...
impl PbsRemotesGetVncwebsocketResponse {
    pub fn new(data: Option<serde_json::Value>) -> PbsRemotesGetVncwebsocketResponse {
