...
pub struct PveRemotesGetClusterStatusResponseDataInner {
    ...
    #[serde(rename = "type")]
    pub r#type: models::PdmPveRemotesTypeEnum,
...
impl PveRemotesGetClusterStatusResponseDataInner {
    pub fn new(id: String, name: String, r#type: models::PdmPveRemotesTypeEnum) -> PveRemotesGetClusterStatusResponseDataInner {
