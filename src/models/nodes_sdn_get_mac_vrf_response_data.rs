...
pub struct NodesSdnGetMacVrfResponseData {
...
impl NodesSdnGetMacVrfResponseData {
    pub fn new(ip: String, mac: String, nexthop: String) -> NodesSdnGetMacVrfResponseData {
