...
pub enum PdmPveRemotesOstypeEnum {
    #[serde(rename = "debian")]
    Debian,
    #[serde(rename = "devuan")]
    Devuan,
...
impl std::fmt::Display for PdmPveRemotesOstypeEnum {
...
impl Default for PdmPveRemotesOstypeEnum {
    fn default() -> PdmPveRemotesOstypeEnum {
        Self::Debian
    }
}
