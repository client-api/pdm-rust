...
pub struct SdnZonesGetZonesResponseDataInner {
    ...
    pub dhcp: Option<models::PdmDhcpEnum>,
    ...
    pub pending: Option<Box<models::SdnZonesGetZonesResponseDataInnerPending>>,
    ...
    #[serde(rename = "type")]
    pub r#type: models::PdmSdnZonesTyEnum,
...
impl SdnZonesGetZonesResponseDataInner {
    pub fn new(remote: String, r#type: models::PdmSdnZonesTyEnum, zone: String) -> SdnZonesGetZonesResponseDataInner {
