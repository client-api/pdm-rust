...
pub enum PdmPbsRemotesStatusEnum {
...
impl std::fmt::Display for PdmPbsRemotesStatusEnum {
...
impl Default for PdmPbsRemotesStatusEnum {
    fn default() -> PdmPbsRemotesStatusEnum {
        Self::Running
    }
}
