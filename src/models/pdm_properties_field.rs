...
#[serde(untagged)]
pub enum PdmPropertiesField {
    PdmPropertiesConfig(Box<models::PdmPropertiesConfig>),
    String(String),
}

impl Default for PdmPropertiesField {
    fn default() -> Self {
        Self::PdmPropertiesConfig(Default::default())
    }
}
