...
pub enum PdmPveRemotesKeyboardEnum {
    #[serde(rename = "de")]
    De,
    #[serde(rename = "de-ch")]
    DeCh,
...
impl std::fmt::Display for PdmPveRemotesKeyboardEnum {
...
impl Default for PdmPveRemotesKeyboardEnum {
    fn default() -> PdmPveRemotesKeyboardEnum {
        Self::De
    }
}
