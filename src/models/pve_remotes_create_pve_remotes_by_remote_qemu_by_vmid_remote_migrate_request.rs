...
pub struct PveRemotesCreatePveRemotesByRemoteQemuByVmidRemoteMigrateRequest {
...
impl PveRemotesCreatePveRemotesByRemoteQemuByVmidRemoteMigrateRequest {
    pub fn new(target: String, target_bridge: Vec<String>, target_storage: Vec<String>) -> PveRemotesCreatePveRemotesByRemoteQemuByVmidRemoteMigrateRequest {
