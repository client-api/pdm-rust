...
pub struct PbsRemotesGetPbsRemotesByRemoteResponse {
...
impl PbsRemotesGetPbsRemotesByRemoteResponse {
    pub fn new(data: Option<serde_json::Value>) -> PbsRemotesGetPbsRemotesByRemoteResponse {
