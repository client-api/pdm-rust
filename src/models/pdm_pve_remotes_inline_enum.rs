...
pub enum PdmPveRemotesInlineEnum {
    #[serde(rename = "inet")]
    Inet,
    #[serde(rename = "inet6")]
    Inet6,
...
impl std::fmt::Display for PdmPveRemotesInlineEnum {
...
impl Default for PdmPveRemotesInlineEnum {
    fn default() -> PdmPveRemotesInlineEnum {
        Self::Inet
    }
}
