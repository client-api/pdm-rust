...
pub struct PveRemotesGetPveRemotesByRemoteLxcByVmidStatusResponseData {
...
impl PveRemotesGetPveRemotesByRemoteLxcByVmidStatusResponseData {
    pub fn new(ha: serde_json::Value, status: models::PdmPbsRemotesStatusEnum, vmid: i32) -> PveRemotesGetPveRemotesByRemoteLxcByVmidStatusResponseData {
