...
#[serde(untagged)]
pub enum PdmUserClassesField {
    PdmUserClassesConfig(Box<models::PdmUserClassesConfig>),
    String(String),
}

impl Default for PdmUserClassesField {
    fn default() -> Self {
        Self::PdmUserClassesConfig(Default::default())
    }
}
