...
#[serde(untagged)]
pub enum PdmBridgePortsField {
    PdmBridgePortsConfig(Box<models::PdmBridgePortsConfig>),
    String(String),
}

impl Default for PdmBridgePortsField {
    fn default() -> Self {
        Self::PdmBridgePortsConfig(Default::default())
    }
}
