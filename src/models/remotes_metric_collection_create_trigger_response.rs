...
pub struct RemotesMetricCollectionCreateTriggerResponse {
...
impl RemotesMetricCollectionCreateTriggerResponse {
    pub fn new(data: Option<serde_json::Value>) -> RemotesMetricCollectionCreateTriggerResponse {
