...
pub struct RemotesRemoteUpdateRemoteResponse {
...
impl RemotesRemoteUpdateRemoteResponse {
    pub fn new(data: Option<serde_json::Value>) -> RemotesRemoteUpdateRemoteResponse {
