...
pub struct PveRemotesGetQemuResponseDataInner {
...
impl PveRemotesGetQemuResponseDataInner {
    pub fn new(status: models::PdmPbsRemotesStatusEnum, vmid: i32) -> PveRemotesGetQemuResponseDataInner {
