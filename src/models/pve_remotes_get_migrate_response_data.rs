...
pub struct PveRemotesGetMigrateResponseData {
    ...
    #[serde(rename = "has-dbus-vmstate", skip_serializing_if = "Option::is_none")]
    ...
    pub local_disks: Vec<models::PveRemotesGetMigrateResponseDataLocalDisksInner>,
    ...
    pub not_allowed_nodes: Option<Box<models::PveRemotesGetMigrateResponseDataNotAllowedNodes>>,
...
impl PveRemotesGetMigrateResponseData {
    pub fn new(local_disks: Vec<models::PveRemotesGetMigrateResponseDataLocalDisksInner>, local_resources: Vec<String>, mapped_resource_info: serde_json::Value, mapped_resources: Vec<String>, running: bool) -> PveRemotesGetMigrateResponseData {
