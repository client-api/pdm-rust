...
pub enum PdmRemotesRemoteInlineEnum {
    #[serde(rename = "web-url")]
    WebUrl,

}

impl std::fmt::Display for PdmRemotesRemoteInlineEnum {
...
impl Default for PdmRemotesRemoteInlineEnum {
    fn default() -> PdmRemotesRemoteInlineEnum {
        Self::WebUrl
    }
}
