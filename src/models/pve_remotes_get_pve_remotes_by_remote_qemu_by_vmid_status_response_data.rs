...
pub struct PveRemotesGetPveRemotesByRemoteQemuByVmidStatusResponseData {
    ...
    pub clipboard: Option<models::PdmPveRemotesClipboardEnum>,
...
impl PveRemotesGetPveRemotesByRemoteQemuByVmidStatusResponseData {
    pub fn new(ha: serde_json::Value, status: models::PdmPbsRemotesStatusEnum, vmid: i32) -> PveRemotesGetPveRemotesByRemoteQemuByVmidStatusResponseData {
