...
pub struct ConfigCertificateUpdateCertificateResponse {
...
impl ConfigCertificateUpdateCertificateResponse {
    pub fn new(data: Option<serde_json::Value>) -> ConfigCertificateUpdateCertificateResponse {
