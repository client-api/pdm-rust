...
#[serde(untagged)]
pub enum PdmAcmedomainField {
    PdmAcmedomainConfig(Box<models::PdmAcmedomainConfig>),
    String(String),
}

impl Default for PdmAcmedomainField {
    fn default() -> Self {
        Self::PdmAcmedomainConfig(Default::default())
    }
}
