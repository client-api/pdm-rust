...
pub enum PdmPveRemotesClipboardEnum {
    #[serde(rename = "vnc")]
    Vnc,

}

impl std::fmt::Display for PdmPveRemotesClipboardEnum {
...
impl Default for PdmPveRemotesClipboardEnum {
    fn default() -> PdmPveRemotesClipboardEnum {
        Self::Vnc
    }
}
