...
pub struct RemotesRemoteCreateRemoteResponse {
...
impl RemotesRemoteCreateRemoteResponse {
    pub fn new(data: Option<serde_json::Value>) -> RemotesRemoteCreateRemoteResponse {
