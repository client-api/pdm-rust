...
pub struct PveRemotesGetLxcResponseDataInner {
...
impl PveRemotesGetLxcResponseDataInner {
    pub fn new(status: models::PdmPbsRemotesStatusEnum, vmid: i32) -> PveRemotesGetLxcResponseDataInner {
